...
public class GridViewCardItemAdapter extends BaseAdapter {
    public static boolean isCardFlipping = false;

    Context context;
    Activity activity;
    private ArrayList<String> listCardContents;
    private LayoutInflater mLayoutInflater;
    private int cardWidth;
    private float textSize;

    public GridViewCardItemAdapter(@NonNull Context context, Activity activity, ArrayList<String> listCardContents, int columnWidth, float textSize) {
